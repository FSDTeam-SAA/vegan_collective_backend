...
exports.createOrganizationInfo = async (req, res) => {
  try {
    upload.single("profilePhoto")(req, res, async (err) => {
      ...
      let { userID, organizationName, address, missionStatement, about, shortDescriptionOfOrganization, experience, certifications, websiteURL, governmentIssuedID, professionalCertification, photoWithID } = req.body;
